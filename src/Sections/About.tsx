...
const About = () => {
  return (
    <section
      id="about"
      className="bg-black min-h-[100svh] flex items-center px-5 py-20"
    >
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 md:gap-16 items-center w-full">
        ...
        <div className="flex flex-col items-center md:items-start gap-8">
          ...
          >
            Amar Construction is led by its partners, Mithil Kansara and Dipen
            Shah, bringing together strong expertise in civil construction and
            electrical engineering. With the support of a qualified partnership
            and an experienced professional team, Amar Construction is committed
            to delivering high-quality construction, strict adherence to safety
